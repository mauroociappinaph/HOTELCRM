          ...
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">
                Bienvenido de vuelta, {profile?.profile?.full_name || user.email}
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm text-gray-500">Agencia</p>
                <p className="font-medium">{profile?.agency?.name || 'Sin agencia'}</p>
              </div>
              <div className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center">
                <span className="text-white font-medium">
                  {profile?.profile?.full_name?.charAt(0) || user.email?.charAt(0)?.toUpperCase()}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">Nueva reserva confirmada</p>
                  <p className="text-sm text-gray-500">Juan Pérez - Viaje a Bariloche</p>
                </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">Mensaje de cliente</p>
                  <p className="text-sm text-gray-500">Consulta sobre itinerario a Mendoza</p>
                </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500">Reserva #1234 - $25,000</p>
                </div>
