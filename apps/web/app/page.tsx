    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">🏨 Hotel CRM</h1>
          <p className="text-xl text-gray-600">Sistema de Gestión para Agencias de Viajes</p>
        </header>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <p className="text-gray-600">Supabase con PostgreSQL + Auth integrado + RLS</p>
            </div>
            ...
            <div className="border-l-4 border-indigo-500 pl-4">
              ...
              <p className="text-gray-600">{SUPPORTED_LANGUAGES.join(', ').toUpperCase()}</p>
            </div>
          </div>
        </div>
